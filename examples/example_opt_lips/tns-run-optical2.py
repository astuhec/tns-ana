...
input_file = DIR + 'examples/example_opt_lips/input.json'
input_temperature = DIR + 'examples/example_opt_lips/input_temperature.json'
input_optical = DIR + 'examples/example_opt_lips/input_optical.json'

''' Add path to output file
results will be saved already during the run, in case the run is not completed '''
file_output = DIR + 'examples/example_opt_lips/optical_results.npz'
